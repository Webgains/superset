...
<<<<<<<< HEAD:superset-frontend/packages/superset-ui-core/src/components/ConfirmStatusChange/types.ts
...
>>>>>>>> 6.1.0:superset-frontend/packages/superset-ui-core/src/validator/types.ts
