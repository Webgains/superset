...
import CustomDateFilterControl from 'src/explore/components/controls/CustomDateFilterControl';
import { PluginFilterTimeProps } from './types';
import { FilterPluginStyle } from '../common';
import { CURRENT_CALENDAR_RANGE_SET } from 'src/explore/components/controls/DateFilterControl';
import { CurrentDay } from 'src/explore/components/controls/CustomDateFilterControl/types';
...
export default function TimeFilterPlugin(props: PluginFilterTimeProps) {
  ...
  return props.formData?.inView ? (
    <TimeFilterStyles width={width} height={height}>
      ...
      >
        <CustomDateFilterControl
          value={filterState.value || CurrentDay}
