 ...
 * under the License.
 */
<<<<<<<< HEAD:superset-frontend/plugins/plugin-chart-ag-grid-table/src/AgGridTable/components/SearchSelectDropdown.tsx
...
export default function FilterDefinitionOption({
  ...
  return null;
>>>>>>>> 6.1.0:superset-frontend/src/explore/components/controls/MetricControl/FilterDefinitionOption.tsx
}
